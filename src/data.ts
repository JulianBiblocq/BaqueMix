...
export const i18n = {
  pt: {
    ...
    legendTarolTremer: "Barulho (Trêmulo)",
    ...
    gongueBarulho: "Barulho (Toque fechado)",
    agbeLegend: "🌾 Agbê",
    ...
    mineiroB: "Barulho (Ruído contínuo)",
    addInst: "adicionar",
    clear: "Limpar a Roda",
    save: "Salvar",
    load: "Carregar",
  ...
  fr: {
    ...
    legendTarolFla: "Fla",
    legendTarolClick: "Click",
    legendTarolTremer: "Barulho (Trémolo)",
    legendAlfaiaBarulho: "Barulho",
    ...
    gongueBarulho: "Barulho (Coup étouffé)",
    agbeLegend: "🌾 Agbê",
    ...
    mineiroB: "Barulho (Bruit continu)",
    addInst: "Ajouter",
    clear: "Vider la Roda",
    save: "Sauvegarder",
    load: "Charger",
